...
import com.example.Employee.service.DeptCallService;
...
public class EmployeeController {
    ...
    DeptCallService service;

    @Autowired
    public EmployeeController(RestTemplate restTemplate, WebClient webClient, APIFeignClient feignClient, DeptCallService service) {
    ...
    public ResponseEntity<ResponseDto> getWebClientInfo(@PathVariable("empId") String empId) {
        ...
        DepartmentDto dto = service.getSingleDto(empId);// block to make it blocking
    ...
    public ResponseEntity<ResponseDto> getDefaultDept(String empId) {
        List<EmployeeDto> list = empList.stream().filter((dto) -> dto.getEmpCode().equals(empId))
                .collect(Collectors.toList());
